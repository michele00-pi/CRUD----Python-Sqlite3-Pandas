...
sqlite3 --> banco de dados
    ...
    cursor.fetchone() --> Recupera um dado(nesse caso foi utlizado para veificar a existencia de um dado no sistema) retorna None não exista
